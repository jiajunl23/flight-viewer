...
/**
 * Thin client for adsb.lol point+radius endpoint.
 * No auth today. Soft dynamic rate limit (empirically generous at 1 req / 3s
 * from Railway). Response schema matches readsb/tar1090 (same as airplanes.live
 * and adsb.fi).
 */
